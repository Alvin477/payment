    ...
    <div className="min-h-screen bg-gray-900 px-4 py-8 flex flex-col justify-center">
      {status?.status === 'CONFIRMED' ? (
        <div className="w-full max-w-md mx-auto">
          <div className="bg-gray-800 shadow-xl border border-gray-700 rounded-2xl p-6 text-center">
            <img src="/success.gif" alt="Success" className="w-40 h-40 mx-auto mb-6"/>
            <h2 className="text-2xl font-bold text-emerald-400 mb-3">Payment Successful!</h2>
            <p className="text-gray-400">Redirecting to dashboard in a few seconds...</p>
          </div>
        </div>
      ) : (
        <div className="w-full max-w-md mx-auto">
